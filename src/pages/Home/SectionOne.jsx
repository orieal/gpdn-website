            ...
            <div className="lg:absolute flex lg:items-center top-[8.5vh] xl:top-[8vh] left-0 w-full h-auto">
              <div className="flex flex-col gap-4 lg:gap-0 lg:justify-between">
                ...
                <div className="flex flex-col w-full gap-3 xl:gap-6">
                  <p className="font-normal text-[2vh]  flex-nowrap">Our global network of dedicated palliative care doctors fosters collaboration, knowledge-sharing, and peer support to enhance patient care across borders.
                  </p>
                  <div>
                   <div className="flex ">
