"use client"
import React, { useEffect, useState } from "react";import { FiArrowRight } from "react-icons/fi";
    ...
    <section className="w-full h-full flex justify-center items-center">
      <div className="h-full w-full">
        <div className="h-full w-full flex flex-col items-start justify-between">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col justify-around w-full h-[50vh] lg:h-full">
