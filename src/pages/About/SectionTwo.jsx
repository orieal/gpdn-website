            ...
            <div className='flex flex-col justify-between'>
              <div className='flex flex-col gap-2'>
                <div className='flex items-center justify-between'>
                  <h6 className='font-poppins text-primary text-4xl font-semibold w-[50%]'>468+</h6>
                  <p className='font-normal text-xl text-[#525252] w-[50%]'>Dedicated <br /> palliative care</p>
                </div>
                <div className='flex items-center justify-between'>
                  <h6 className='font-poppins text-primary text-4xl font-semibold w-[50%]'>80+</h6>
                  <p className='font-normal text-xl text-[#525252] w-[50%]'>Countries <br /> represented</p>
                </div>
                <div className='flex items-center justify-between'>
                  <h6 className='font-poppins text-primary text-4xl font-semibold w-[50%]'>1000+</h6>
                  <p className='font-normal text-xl text-[#525252] w-[50%]'>Case <br />discussions</p>
                </div>
              </div>
