...
const MobileMenu = ({ isShowMenu, setIsShowMenu }) => {
  ...
  return (
    ...
    >
      <div className="h-full w-full flex flex-col justify-start gap-10 p-8 pt-20">
        {/* Navigation Links */}
        ...
        <div className="pt- border-t border-gray-200 flex flex-col gap-4">
          <Link onClick={() => setIsShowMenu(!isShowMenu)} href="/registration">
            <button className="w-full bg-black hover:bg-[#039187] cursor-pointer transition-all duration-300 ease-in text-white text-base font-medium py-3 px-3 rounded-xl flex items-center justify-center gap-2 shadow-lg hover:shadow-xl">
              Join Us
              <GoChevronRight className="text-xl" />
            </button>
          </Link>
          <Link onClick={() => setIsShowMenu(!isShowMenu)} href="/signin">
            <button className="w-full bg-teal-500 hover:bg-[#039187] cursor-pointer transition-all duration-300 ease-in text-white text-base font-medium py-3 px-3 rounded-xl flex items-center justify-center gap-2 shadow-lg hover:shadow-xl">
              Sign In
              <GoChevronRight className="text-xl" />
            </button>
          </Link>
