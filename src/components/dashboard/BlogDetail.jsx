...
const BlogDetail = ({ id }) => {
        ...
        if (response.data && response.data.data) {
          ...
          setBlog({
            ...
            dislikes: Array.isArray(blog.dislikes)
              ? blog.dislikes.filter((dislike) =>
                  typeof dislike === "object"
                    ? dislike._id !== userId
                    : dislike !== userId
                )
              : blog.dislikes || [],
        ...
        if (response.data && response.data.data) {
          ...
          setBlog({
            ...
            dislikes:
              ...
              blog.dislikes.some((dislike) => {
                return typeof dislike === "object"
                  ? dislike._id === userId
                  : dislike === userId;
              })
                ? blog.dislikes.filter((dislike) =>
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      />
      {/* Main Content */}
      <div className="flex-1 md:ml-24 p-8 mt-16 md:mt-0">
        {loading ? (
          <div className="max-w-4xl mx-auto">
            ...
            <Skeleton.Input
              active
              size="large"
              style={{ width: "70%", height: 40, marginBottom: 24 }}
            />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {/* <div className="mt-12">
                    ...
                    <div className="flex-1">
                      ...
                      {replyingTo === comment._id && (
                        <div className="mt-3 relative">
                          ...
                          />
                          <button
                            className={`absolute right-2 bottom-2 text-[#00A99D] hover:text-[#008F84] transition-colors ${
              ...
              <div className="mt-6 relative">
                ...
                />
                <button
                  className={`absolute right-3 bottom-3 text-[#00A99D] hover:text-[#008F84] transition-colors ${
