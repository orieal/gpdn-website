...
import { MdClose, MdDashboard, MdLogout, MdMenu } from "react-icons/md";
...
const NewsAndBlogs = () => {
  ...
  const handleLikeDislike = async (post, action) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        message.success(
          `Blog ${action === "like" ? "liked" : "disliked"} successfully`
        );
      } else {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      {/* Main Content */}
      <div className="grid md:flex-1 md:ml-64 mt-16 md:mt-0">
        {/* Header */}
        <div className="p-5 md:flex justify-between items-center border-b border-gray-200 bg-white fixed md:w-[calc(100%-256px)] z-10">
          ...
          <div className="mt-1 md:mt-0 flex gap-3 relative filter-container">
            <Input
              placeholder="Search..."
              className="w-64"
            ...
            {/* Filter Dropdown */}
            {showFilter && (
              <div className="absolute right-0 top-12 md:w-64 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden z-20">
        ...
        <div className="pt-20 p-5 mt-10">
          {loading ? (
            ...
            <div className="ml-16 md:ml-0 flex flex-col items-center justify-center py-10">
                    ...
                    <div className="p-3">
                      ...
                      <div className="flex items-center gap-4 text-gray-500">
                        <button
                          ...
                          className={`flex items-center gap-2 hover:text-[#00A99D] transition-colors ${
                            isLiked ? "text-[#00A99D]" : ""
                          }`}
                        >
